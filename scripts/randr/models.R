...
cor.test(df[df$female == 0, 'depression_2'], df[df$female == 0, 'FC_controlb_pos_2'])
cor.test(df[df$female == 1, 'depression_2'], df[df$female == 1, 'FC_controlb_pos_2'])

# Control C (13)
tab_model(a_exp_controlc_viol, b_exp_controlc_viol, c_exp_controlc_viol, d_exp_controlc_viol)
tab_model(a_FC_controlc_viol, b_FC_controlc_viol, c_FC_controlc_viol, d_FC_controlc_viol)
tab_model(a_depression_exp_controlc, b_depression_exp_controlc, c_depression_exp_controlc, d_depression_exp_controlc)
tab_model(a_depression_FC_controlc, b_depression_FC_controlc, c_depression_FC_controlc, d_depression_FC_controlc)
cor.test(df[df$female == 0, 'depression_2'], df[df$female == 0, 'FC_controlc_pos_2'])
cor.test(df[df$female == 1, 'depression_2'], df[df$female == 1, 'FC_controlc_pos_2'])

# Default A (14)
tab_model(a_exp_defaulta_viol, b_exp_defaulta_viol, c_exp_defaulta_viol, d_exp_defaulta_viol)
tab_model(a_FC_defaulta_viol, b_FC_defaulta_viol, c_FC_defaulta_viol, d_FC_defaulta_viol)
tab_model(a_depression_exp_defaulta, b_depression_exp_defaulta, c_depression_exp_defaulta, d_depression_exp_defaulta)
tab_model(a_depression_FC_defaulta, b_depression_FC_defaulta, c_depression_FC_defaulta, d_depression_FC_defaulta)
cor.test(df[df$female == 0, 'depression_2'], df[df$female == 0, 'FC_defaulta_pos_2'])
cor.test(df[df$female == 1, 'depression_2'], df[df$female == 1, 'FC_defaulta_pos_2'])

# Default B (15)
tab_model(a_exp_defaultb_viol, b_exp_defaultb_viol, c_exp_defaultb_viol, d_exp_defaultb_viol)
tab_model(a_FC_defaultb_viol, b_FC_defaultb_viol, c_FC_defaultb_viol, d_FC_defaultb_viol)
tab_model(a_depression_exp_defaultb, b_depression_exp_defaultb, c_depression_exp_defaultb, d_depression_exp_defaultb)
tab_model(a_depression_FC_defaultb, b_depression_FC_defaultb, c_depression_FC_defaultb, d_depression_FC_defaultb)
cor.test(df[df$female == 0, 'depression_2'], df[df$female == 0, 'FC_defaultb_pos_2'])
cor.test(df[df$female == 1, 'depression_2'], df[df$female == 1, 'FC_defaultb_pos_2'])

# Default C (16)
tab_model(a_exp_defaultc_viol, b_exp_defaultc_viol, c_exp_defaultc_viol, d_exp_defaultc_viol)
tab_model(a_FC_defaultc_viol, b_FC_defaultc_viol, c_FC_defaultc_viol, d_FC_defaultc_viol)
tab_model(a_depression_exp_defaultc, b_depression_exp_defaultc, c_depression_exp_defaultc, d_depression_exp_defaultc)
tab_model(a_depression_FC_defaultc, b_depression_FC_defaultc, c_depression_FC_defaultc, d_depression_FC_defaultc)
cor.test(df[df$female == 0, 'depression_2'], df[df$female == 0, 'FC_defaultc_pos_2'])
cor.test(df[df$female == 1, 'depression_2'], df[df$female == 1, 'FC_defaultc_pos_2'])

# Temporal Parietal (17)
tab_model(a_exp_temporalparietal_viol, b_exp_temporalparietal_viol, c_exp_temporalparietal_viol, d_exp_temporalparietal_viol)
tab_model(a_FC_temporalparietal_viol, b_FC_temporalparietal_viol, c_FC_temporalparietal_viol, d_FC_temporalparietal_viol)
tab_model(a_depression_exp_temporalparietal, b_depression_exp_temporalparietal, c_depression_exp_temporalparietal, d_depression_exp_temporalparietal)
tab_model(a_depression_FC_temporalparietal, b_depression_FC_temporalparietal, c_depression_FC_temporalparietal, d_depression_FC_temporalparietal)
cor.test(df[df$female == 0, 'depression_2'], df[df$female == 0, 'FC_temporalparietal_pos_2'])
cor.test(df[df$female == 1, 'depression_2'], df[df$female == 1, 'FC_temporalparietal_pos_2'])