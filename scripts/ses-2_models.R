...
boo2.2 <- lm(FC_b_pos ~ num_pastyear*female, d=d2) #sig: none
...
# age sensitivity
goo1 <- lm(depression ~ num_pastyear*female + age_mri, d=d2) #sig: female, and femaleXnum_pastyear
goo2 <- lm(exp_b_pos ~ num_pastyear*female + age_mri, d=d2) #sig: none
goo2.2 <- lm(FC_b_pos ~ num_pastyear*female + age_mri, d=d2) #sig: none
goo3 <- lm(depression ~ exp_b_pos*female + age_mri, d=d2) #sig: exp_b_pos, female
goo3.2 <- lm(depression ~ FC_b_pos*female + age_mri, d=d2) #sig: FC_b_pos, female, FC_b_posXfemale
...
foo1 <- lm(depression_2 ~ num_pastyear_2*female + age_mri_2 + depression_1, d=df) #sig: just depression_1
foo2 <- lm(exp_b_pos_2 ~ num_pastyear_2*female + age_mri_2 + exp_b_pos_1, d=df) #sig: just exp_b_pos_1 
foo2.2 <- lm(FC_b_pos_2 ~ num_pastyear_2*female + age_mri_2 + FC_b_pos_1, d=df) #sig: just foo2.2
